...
function Overview() {
  ...
  const [imageUrl, setImageUrl] = useState(
    "https://i.ibb.co/1XHmBQ8/videoOne.gif"
  );
  function showItems(name: string) {
    if (name === "docs") {
      setHeading("The world's most powerful (and fun) Docs.");
      setImageUrl(
        "https://i.ibb.co/jr0Rp9F/localhost-3000-dashboard-tickets.png"
      );
      document.getElementById("docsId")?.classList.add("border-indigo-500");
      document
        .getElementById("whiteboardsId")
        ?.classList.remove("border-indigo-500");
      document
      ...
      setImageUrl(
        "https://i.ibb.co/h1M0Vv9/localhost-3000-dashboard-manage-User-Roles.png"
      );
      document
        .getElementById("whiteboardsId")
      ...
      setImageUrl(
        "https://i.ibb.co/5WCVw0W/localhost-3000-dashboard-project-Details.png"
      );
      document
        .getElementById("dashboardId")
        ?.classList.add("border-indigo-500");
