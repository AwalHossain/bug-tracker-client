    ...
    <div className="mx-1 my-12 rounded-[55px] bg-green-100  md:max-w-3xl lg:mx-auto lg:max-w-7xl">
      <div className="grid gap-10 px-4 py-10 md:mx-auto md:max-w-3xl lg:mx-auto lg:max-w-6xl lg:grid-cols-2">
        ...
        <div className="order-2 max-w-3xl lg:order-1 ">
          <p className="mb-5 text-sm font-bold text-emerald-500">
            {" "}
            THE PLATFORM
          </p>
          ...
          <p
            ...
            style={{ color: "#292d34" }}
          >
            Customize GrabBug to tackle any project or task with 35+ ClickApps.
            Break down work with subtasks, assign Sprint Points, link tasks to
            other items with Relationships, and more
          </p>
        </div>
